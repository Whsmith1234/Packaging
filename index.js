...
function packageCon(w,l,h){
  ...
  var d = l/2;
  var shift = (1 - Math.cos(theta)) * l/2;
  var zshift = s * c * d + s*(shift);
  var yshift = -(s * s * d) + c*(shift);
  translate(0,yshift,zshift);
